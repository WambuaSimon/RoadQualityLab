...
package com.softteco.roadqualitydetector.view;
...
public class PieGraph extends View {
    ...
    public PieGraph(final Context context) {
        this(context, null);
    }

    public PieGraph(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PieGraph(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs);
    ...
    public void setBackgroundBitmap(final Bitmap backgroundBitmap, final int pos_x, final int pos_y) {
        mBackgroundImage = backgroundBitmap;
        mBackgroundImageAnchor.set(pos_x, pos_y);
        postInvalidate();
    }

    public void setBackgroundBitmap(final Bitmap backgroundBitmap) {
    ...
    public void setInnerCircleRatio(final int innerCircleRatio) {
    ...
    public void setSlices(final ArrayList<PieSlice> slices) {
        mSlices = slices;
        postInvalidate();
    }
    ...
    public void setDuration(final int duration) {mDuration = duration;}

    public Interpolator getInterpolator() {
        return mInterpolator;
    }

    public void setInterpolator(final Interpolator interpolator) {mInterpolator = interpolator;}
    ...
    public void animateToGoalValues() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR1){
            Log.e(TAG, "Animation not supported on api level 12 and below. Returning without animating.");
            return;
        }
        if (mValueAnimator != null)
            mValueAnimator.cancel();
    ...
    public void setAnimationListener(final Animator.AnimatorListener animationListener) { mAnimationListener = animationListener;}
