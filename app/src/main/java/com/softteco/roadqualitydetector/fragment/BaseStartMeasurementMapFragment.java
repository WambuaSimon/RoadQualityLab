...
import com.softteco.roadqualitydetector.util.MeasurementsGoogleMapHelper;

import java.util.List;

public abstract class BaseStartMeasurementMapFragment extends StartMeasurementFragment {
